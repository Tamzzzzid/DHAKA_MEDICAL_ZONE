...
public class Form6B extends JFrame implements ActionListener //TAKE APPOINMENT WILL COME FROM CHOOSE DOC
{
		...
		public Form6B()
		{
		  ...
		  //doctor buttons
		  b3 = new JButton("DR JANNATUL TANZILA");
		  ...
		  b7 = new JButton("DR MOMINA MUSTAHESAN");
		...
		public void actionPerformed(ActionEvent ae)
		{
			if(ae.getSource()==b3)
			{
			 ...
			 ff.t12.setText("JANNATUL TANZILA");
			 ff.t14.setText("7");
			...
			else if(ae.getSource()==b7)
			{
			 ...
			 ff.t8.setText(w3.getText());
			 ff.t10.setText(w4.getText());
			 ff.t12.setText("MOMINA MUSTAHISAN");
			 ff.t14.setText("23");
