...
public class Form6 extends JFrame implements ActionListener //TAKE APPOINMENT WILL COME FROM CHOOSE DOC
{
		...
		public Form6()
		{
		  ...
		  //doctor buttons
		  b3 = new JButton("DR METHILA WOISHE");
		  ...
		  b4 = new JButton("DR TOFAYEL SULTAN");
		  ...
		  b5 = new JButton("DR NEEHAL NASEEM");
		  ...
		  b8 = new JButton("DR PRITOM HASAN");
