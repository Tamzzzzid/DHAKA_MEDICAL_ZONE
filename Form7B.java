...
public class Form7B extends JFrame implements ActionListener //DOCTOR LIST
{
		...
		public void actionPerformed(ActionEvent ae)
		{
			...
			{
			 Form8 ff=new Form8();
			 ff.t2.setText("JANNATUL TANZILA");
			...
			{
			 Form8 ff=new Form8();
			 ff.t2.setText("MOMINA MUSTAHESAN");
